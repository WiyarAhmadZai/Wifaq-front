...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      /* Back to whatever sent us here — a scanned student card, say. Only
       * in-app paths: a "//evil.example" would otherwise leave the site. */
      const wanted = new URLSearchParams(window.location.search).get('redirect');
      const safe = wanted && wanted.startsWith('/') && !wanted.startsWith('//') ? wanted : '/';
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-teal-100 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            <h2 className="text-sm font-semibold text-gray-800 mb-4 text-center">Sign In</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors text-xs"
                    placeholder="admin@wifaq.edu"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full pl-9 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors text-xs"
              ...
              <div className="flex items-center justify-between text-xs">
                <label className="flex items-center">
                  <input type="checkbox" className="w-3.5 h-3.5 text-teal-600 rounded focus:ring-teal-500" />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2 px-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 focus:ring-2 focus:ring-teal-200 transition-all font-medium text-xs disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1.5"
              >
                {loading ? (
                  <>
