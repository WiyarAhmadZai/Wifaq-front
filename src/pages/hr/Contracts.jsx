                ...
                {items.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2 text-xs">
                      <span
                        className={`inline-block px-2 py-0.5 rounded-full text-[10px] font-medium ${getContractTypeBadge(item.contract_type)}`}
                      >
                        {item.contract_type?.replace("_", " ")}
                      </span>
                    </td>
                    <td className="px-3 py-2 text-xs text-gray-600">
                      {formatDateYDM(item.start_date)}
                    </td>
                    <td className="px-3 py-2 text-xs text-gray-600">
                      {item.expected_time || "-"}
                    </td>
                    ...
                    <td className="px-3 py-2 text-xs text-gray-800">
                      AFN {parseFloat(item.salary).toLocaleString()}
                    </td>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            ...
            <div className="p-4 space-y-4">
              <div>
                ...
                <div
                  className={`px-3 py-2 rounded-lg ${getStatusBadge(selectedContract?.status)} text-sm`}
                >
